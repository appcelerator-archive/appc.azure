...
exports.create = function(APIBuilder, server) {
	...
	return Connector.extend({
		...
		query: function(Model, options, callback) {
			...
			if (options.order || options.page || options.unsel || options.per_page || options.skip) {
				return callback('"order", "skip", "unsel", "page" and "per_page" are not currently supported by the Azure connector.');
			}
